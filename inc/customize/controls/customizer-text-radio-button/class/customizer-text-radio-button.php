 ...
 */
 class vw_appoinment_pro_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
 ...
 */
if ( ! function_exists( 'vw_appoinment_pro_text_sanitization' ) ) {
	function vw_appoinment_pro_text_sanitization( $input ) {
