<?php
	...
	class vw_appoinment_pro_Slider_Custom_Control extends WP_Customize_Control {
		/**
	...
	function vw_appoinment_pro_slider_line_script() {
	...
	add_action( 'customize_controls_enqueue_scripts', 'vw_appoinment_pro_slider_line_script' );
