...
class vw_appoinment_pro_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="total-icon-list clearfix">
                    ...
                    <?php
                    $vw_appoinment_pro_font_awesome_icon_array = vw_appoinment_pro_font_awesome_icon_array();
                    foreach ($vw_appoinment_pro_font_awesome_icon_array as $vw_appoinment_pro_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_appoinment_pro_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_appoinment_pro_font_awesome_icon).'"></i>
                            <span class="vw-social-class">'.esc_attr($vw_appoinment_pro_font_awesome_icon).'</span></li>';
                        }
                    ?>
                </ul>
...
function vw_appoinment_pro_customizer_script() {
...
add_action( 'customize_controls_enqueue_scripts', 'vw_appoinment_pro_customizer_script' );

if(!function_exists('vw_appoinment_pro_font_awesome_icon_array')){
    function vw_appoinment_pro_font_awesome_icon_array(){
