...
class vw_appoinment_pro_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'vw_appoinment_pro_About_Widget',
			__('VW About Us', 'vw-appointment-pro'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-appointment-pro' ), ) 
		);
	}
	...
	?>
		<p>
        <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:','vw-appointment-pro'); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>">
    	</p>
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-appointment-pro'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-appointment-pro'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-appointment-pro'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-appointment-pro'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-appointment-pro'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-appointment-pro'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_appoinment_pro_about_custom_load_widget() {
	register_widget( 'vw_appoinment_pro_About_Widget' );
}
add_action( 'widgets_init', 'vw_appoinment_pro_about_custom_load_widget' );